...
- [2. Tipos primitivos e funções](#2-tipos-primitivos-e-funções)
  - [2.2 Definições](#22-definições)
  - [2.3 Funções](#23-funções)
  - [2.4 Currying](#24-currying)
  - [2.5 Composição](#25-composição)
  - [2.6 Recursão](#26-recursão)
  - [2.7 Funções do Preludio](#27-funções-do-preludio)
