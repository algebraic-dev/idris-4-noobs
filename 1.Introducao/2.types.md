...
Exercicios:
  - Implemente a função fibonnaci em Idris de forma recursiva. Seguindo a definição: 
    `fib(0) = 1` 
    `fib(1) = 1`
...
Exercicios:
- Faça algumas composições entre essas funções apresentadas 
- Faça uma função recursiva que repita o caractere passado `n` vezes. por exemplo: <br>
