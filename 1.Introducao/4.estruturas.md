...
```idris
responda : String -> String
responda "Mas e se for mentira?" = "Pior que é verdade."
responda "Sei não eim" = "É verdade, eu averiguei."
responda outro = "Voce perguntou... '\{outro}'? Não sei lhe responder isso no momento."
```
