...
Nessa parte, vamos dar uma olhada em algumas expressões para deixar nosso programa mais completo e mais legível.
...
Quando duas variáveis locais tem o mesmo nome, a ultima variável é a que vai manter o valor. Isso é chamado de *Shadowing* já que a variável declarada mais externamente vai ser "obscurecida" por uma outra de mesmo nome. Por exemplo,
